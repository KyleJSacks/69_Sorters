...
public class Merger {
    ...
    public void merge(
      ...
      , int nItems  // number of items in the merged list
		  ...
		  int limit0 = start1 - 1;
		  int limit1 = nItems - 1;
		  System.out.println(limit0 + " " + limit1 + " " + usersData.size());
	...
	public static ArrayList<String> mergeR(ArrayList<String> L1, ArrayList<String> L2){
		return mergeR(L1, L2, new ArrayList<String>());
	}
	
	public static ArrayList<String> mergeR(ArrayList<String> L1, ArrayList<String> L2, ArrayList<String> Solution){
		if (L1.size() == 0){
			for(String i: L1){
				Solution.add(i);
			}
